...
QPlainTextEdit {
  ...
  font-family: %1;
    ...
    connect(widgets_.text_view, &QPlainTextEdit::copyAvailable, actions_.act_copy,
            &QAction::setEnabled);
    widgets_.text_view->addAction(actions_.act_copy);
    connect(actions_.act_copy, &QAction::triggered, this, &LogViewer::copy);
    // Save logs
    actions_.act_save_logs = new QAction(tr("Save Logs..."), widgets_.text_view);
    widgets_.text_view->addAction(actions_.act_save_logs);
    connect(actions_.act_save_logs, &QAction::triggered, this, &LogViewer::saveLogs);
}

void LogViewer::log(const QString& msg)
{
    widgets_.text_view->appendHtml(msg);
}

void LogViewer::copy() const
{
    widgets_.text_view->copy();
}

void LogViewer::saveLogs()
{
    ...
    if (!out_file.open(QFile::WriteOnly)) {
        QMessageBox::critical(this, tr("Error saving log file"),
...
const char* WidgetLogFormatter::logStyle(spdlog::level::level_enum level)
{
    ...
    case spdlog::level::debug:
        return "font-style: normal; font-weight: normal; color: #777777;";
    case spdlog::level::info:
        return "font-style: normal; font-weight: normal; color: #CCCCCC;";
    case spdlog::level::warn:
        return "font-style: normal; font-weight: normal; color: #FF7F00;";
    case spdlog::level::err:
        return "font-style: normal; font-weight: normal; color: #FF0000;";
    case spdlog::level::critical:
        return "font-style: normal; font-weight: bold; color: #FF0000;";
    default:
        return "";
    }
}
